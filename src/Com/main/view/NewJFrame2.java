...
public class NewJFrame2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Opening Balance amount:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String opbalam1=jTextField5.getText().trim();
        Statement stmt = null;
           try{
            stmt = connection.createStatement();
            System.out.println("Inserting records into the table...");
            String sql = "INSERT INTO `tbl_account` (`name`, `age`, `address`,`opbalam`)  VALUES('" + name + "','" + age + "','" + address + "','"+opbalam1+"')";
            //execute a query
            ...
            JOptionPane.showConfirmDialog(jButton1, "Account Created Successfully!!!!");
